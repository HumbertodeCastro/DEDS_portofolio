...
# Define default values for the variables before using them
type_activity = "default_activity_type"
activity_radius = 0  # or some default value
...
def process():
    ...
    GO_SALES_INVENTORY_LEVELSData = pd.read_csv(settings.CSV_PATHS['go_inv_con'], index_col=False)
    GO_SALES_PRODUCT_FORECASTData = pd.read_csv(settings.CSV_PATHS['go_forecast_con'], index_col=False)
